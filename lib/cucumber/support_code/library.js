var Library = function(supportCodeDefinition) {
  ...
  var transforms       = Cucumber.Type.Collection();
  ...
  var self = {
    ...
    defineTransform: function defineTransform(pattern, handler) {
      var transform = Cucumber.SupportCode.Transform(pattern, handler);
  ...
  var supportCodeHelper = {
    ...
    Transform        : self.defineTransform,
