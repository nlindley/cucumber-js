var StepDefinition = function (pattern, code) {
  ...
  var self = {
    ...
    invoke: function invoke(step, world, transforms, callback) {
      ...
      var parameters      = self.buildInvocationParameters(step, transforms, codeCallback);
    ...
    buildInvocationParameters: function buildInvocationParameters(step, transforms, callback) {
      ...
      if (step.hasAttachment()) {
        ...
        parameters.forEach(function(parameter, index) {
          transforms.forEach(function(transform) {
            parameters[index] = transform.transform(parameter);
          }, cb)
        });
      }
